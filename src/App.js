  ...
  return (
    <div className="App">
        ...
        <Routes>
          ...
          <Route path="/travel" element={isLoggedIn ? <PathfindingVisualizer /> : <Login setLoggedIn={setIsLoggedIn} destination={location.pathname} />} />
          ...
          <Route path="/signup" element={<Signup />} />
            ...
            <Routes>
                ...
                <Route path="/travel" component={PathfindingVisualizer} />
